...
user in an INI file next to AHKStudioPortable.exe called AHKStudioPortable.ini.
...
copy AppNamePortable.ini from this directory to AHKStudioPortable.ini next to
AHKStudioPortable.exe. The options in the INI file are as follows:
